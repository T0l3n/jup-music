...
module.exports = {
  ...
  description: "Gestiona los Bot-Chats!", //the command description for helpcmd [OPTIONAL]
  ...
  options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!	
    ...
    //{"IntChoices": { name: "what_ping", description: "What Ping do you want to get?", required: true, choices: [["Bot", 1], ["Discord Api", 2]] }, //here the second array input MUST BE A NUMBER // TO USE IN THE CODE: interacton.getInteger("what_ping")
    {
      "StringChoices": {
        name: "what_to_do",
        description: "Qué es lo que quieres hacer?",
        required: true,
        choices: [
    ...
    }, //here the second array input MUST BE A STRING // TO USE IN THE CODE: interacton.getString("what_ping")
    {
      "Channel": {
        name: "which_channel",
        description: "¿Qué canal desea agregar/eliminar?",
        required: true
      }
      ...
      if (add_remove == "add") {
        if (client.settings.get(guild.id, "botchannel").includes(Channel.id)) {
          return interaction.reply({
            ...
            embeds: [
              ...
              .setTitle(`${client.allEmojis.x} **Este canal ya está en la Whitelist de Bot-Channel!**`)
            ],
          })
        }
        ...
        return interaction.reply({
          ...
          embeds: [
            ...
            .setColor(ee.color)
            .setFooter(ee.footertext, ee.footericon)
            .setTitle(`${client.allEmojis.check_mark} **El canal \`${Channel.name}\` se agregó a la ${client.settings.get(guild.id, "djroles").length - 1} Whitelist de Bot-Channels!**`)
        ...
        if (!client.settings.get(guild.id, "botchannel").includes(Channel.id)) {
          return interaction.reply({
            ...
            embeds: [
              ...
              .setColor(ee.wrongcolor)
              .setFooter(ee.footertext, ee.footericon)
              .setTitle(`${client.allEmojis.x} **Este canal aún no está incluido en la Whitelist de Bot-Channel!**`)
            ],
          })
        }
        ...
        return interaction.reply({
          ...
          embeds: [
            ...
            .setColor(ee.color)
            .setFooter(ee.footertext, ee.footericon)
            .setTitle(`${client.allEmojis.check_mark} **El canal \`${Channel.name}\` fue eliminado de la ${client.settings.get(guild.id, "djroles").length} Whitelist de Bot-Channels!**`)
            .addField(`🎧 **Bot-Channel${client.settings.get(guild.id, "botchannel").length > 1 ? "s": ""}:**`, `>>> ${djs}`, true)
          ],
        })
      }
