...
module.exports = {
  ...
  options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!	
    ...
    }, //here the second array input MUST BE A STRING // TO USE IN THE CODE: interacton.getString("what_ping")
    {
      "Role": {
        name: "which_role",
        description: "¿Qué función desea agregar/eliminar?",
        required: true
      }
      ...
      if (add_remove == "add") {
        if (client.settings.get(guild.id, "djroles").includes(Role.id)) {
          return interaction.reply({
            ...
            embeds: [
              ...
              .setTitle(`${client.allEmojis.x} **Este Rol ya es un ROL DE DJ!**`)
            ],
          })
        }
        ...
        return interaction.reply({
          ...
          embeds: [
            ...
            .setColor(ee.color)
            .setFooter(ee.footertext, ee.footericon)
            .setTitle(`${client.allEmojis.check_mark} **El rol \`${Role.name}\` se agregó a ${client.settings.get(guild.id, "djroles").length - 1} DJ-Roles!**`)
        ...
        if (!client.settings.get(guild.id, "djroles").includes(Role.id)) {
          return interaction.reply({
            ...
            embeds: [
              ...
              .setColor(ee.wrongcolor)
              .setFooter(ee.footertext, ee.footericon)
              .setTitle(`${client.allEmojis.x} **El rol aún no es un DJ-ROLE!**`)
            ],
          })
        }
