...
module.exports = {
	...
	description: "Muestra la letra de la canción actual", //the command description for Slash Command Overview
	cooldown: 25,
			...
			try {
				...
				return interaction.reply({
					embeds: [new MessageEmbed()
						.setColor(ee.wrongcolor)
						.setFooter(ee.footertext, ee.footericon)
						.setTitle(`${client.allEmojis.x} Las letras están deshabilitadas!`)
						.setDescription(`**Por motivos legales, las letras están deshabilitadas y no funcionarán durante un tiempo desconocido.!** :cry:`)
					],
				})
			} catch (e) {
