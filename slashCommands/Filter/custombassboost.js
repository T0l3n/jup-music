...
module.exports = {
	...
	description: "Establece un Bassboost personalizado con ganancia!", //the command description for Slash Command Overview
	cooldown: 5,
	...
	options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!
		...
		//{"Channel": { name: "in_where", description: "In What Channel should I send it?", required: false }}, //to use in the code: interacton.getChannel("what_channel")
		{
			"Integer": {
				name: "bass_gain",
				description: "¿Qué ganancia debe tener el Bassboost?",
				required: true
			}
				...
				if (bass_gain > 20 || bass_gain < 0) {
					return interaction.reply({
						embeds: [
							...
							.setColor(ee.wrongcolor)
							.setFooter(ee.footertext, ee.footericon)
							.setTitle(`${client.allEmojis.x} **La ganancia de Bassboost debe estar entre 0 y 20!**`)
						],
					})
				}
