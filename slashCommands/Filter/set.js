...
module.exports = {
	...
	description: "Establece (sobrescribe) todos los filtros", //the command description for Slash Command Overview
	cooldown: 5,
	...
	options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!
		...
		//{"Channel": { name: "in_where", description: "In What Channel should I send it?", required: false }}, //to use in the code: interacton.getChannel("what_channel")
		{
			"String": {
				name: "filters",
				description: "Agregue todos los filtros con un espacio entre ellos, para configurar!",
				required: true
			}
				...
				if (filters.some(a => !FiltersSettings[a])) {
					return interaction.reply({
						embeds: [
							...
							.setDescription("**Para definir filtros múltiples, agregue un ESPACIO (` `) in between!**")
