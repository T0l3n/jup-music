...
module.exports = {
	...
	description: "Elimina un filtro de la cola", //the command description for Slash Command Overview
	cooldown: 5,
	...
	options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!
		...
		//{"Role": { name: "what_role", description: "To Ping a Role lol", required: false }}, //to use in the code: interacton.getRole("what_role")
		{
			"String": {
				name: "filters",
				description: "Agregue todos los filtros con un espacio en medio, para eliminar!",
				required: true
			}
				...
				if (!toRemove || toRemove.length == 0) {
					return interaction.reply({
						embeds: [
							...
							.setColor(ee.wrongcolor)
							.setFooter(ee.footertext, ee.footericon)
							.setTitle(`${client.allEmojis.x} **No agregaste un Filtro, que está en los Filtros.**`)
