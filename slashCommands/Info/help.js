...
module.exports = {
  ...
  options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!	
    ...
    //{"Integer": { name: "ping_amount", description: "How many times do you want to ping?", required: true }}, //to use in the code: interacton.getInteger("ping_amount")
    {
      "String": {
        name: "specific_cmd",
        description: "¿Quiere detalles de un comando especifico?",
        required: false
      }
      ...
      if (args && args.length > 0) {
        ...
        if (!cmd) {
          return interaction.reply({
            ephemeral: true,
            embeds: [embed.setColor(ee.wrongcolor).setDescription(`No se encontr¨® informaci¨®n para el comando **${args.toLowerCase()}**`)]
          });
        }
        ...
        const embed = new MessageEmbed()
          ...
          .setDescription(`**[Invitarme con __Slash Commands__ Permisos](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot%20applications.commands), porque todos mis comandos tambi¨¦n est¨¢n disponibles como Slash Commands!**\n\n> Revise la [**Dashboard**](${websiteSettings.website.domain}/dashboard/${guild.id}) o el [**Live Music Queue**](${websiteSettings.website.domain}/queue/${guild.id})`)
