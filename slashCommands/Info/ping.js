...
module.exports = {
	...
	description: "Te da información sobre qué tan rápido es el Bot", //the command description for Slash Command Overview
	cooldown: 1,
	...
	options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!	
		...
		//{"IntChoices": { name: "what_ping", description: "What Ping do you want to get?", required: true, choices: [["Bot", 1], ["Discord Api", 2]] }, //here the second array input MUST BE A NUMBER // TO USE IN THE CODE: interacton.getInteger("what_ping")
		{
			"StringChoices": {
				name: "what_ping",
				description: "¿Qué Ping quieres obtener?",
				required: false,
				choices: [
					["Bot", "botping"],
					["Discord Api", "api"]
			...
			if (StringOption) {
				if (StringOption == "botping") {
					await interaction.reply({
						ephemeral: true,
						content: `${client.allEmojis.loading} Obteniendo el ping del bot...`,
						ephemeral: true
					});
