...
module.exports = {
	...
	description: "Salta a una canción específica en la cola", //the command description for Slash Command Overview
	cooldown: 10,
				...
				if (!args[0]) {
					return message.reply({
						embeds: [new MessageEmbed()
							.setColor(ee.wrongcolor)
							.setFooter(ee.footertext, ee.footericon)
							.setTitle(`${client.allEmojis.x} **Agregue una posición a la que saltar!**`)
