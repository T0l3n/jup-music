...
module.exports = {
	...
	description: "Cambia la velocidad de la canción!", //the command description for Slash Command Overview
	cooldown: 5,
				...
				if (!args[0]) {
					return message.reply({
						embeds: [
							...
							.setColor(ee.wrongcolor)
							.setFooter(ee.footertext, ee.footericon)
							.setTitle(`${client.allEmojis.x} **Agregue una cantidad de velocidad entre 0+ y 2!**`)
						],
					})
				}
