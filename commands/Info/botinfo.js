...
module.exports = {
    ...
    description: "Muestra información sobre el bot", //the command description for helpcmd [OPTIONAL]
            ...
            cpuStat.usagePercent(function (e, percent, seconds) {
                try {
                    ...
                    const botinfo = new MessageEmbed()
                        ...
                        .setFooter("Coded by: Tolen", "https://media.discordapp.net/attachments/988223337555701760/1065056312297275432/static.png?width=832&height=468");
                    message.reply({
                        embeds: [botinfo]
                    });
